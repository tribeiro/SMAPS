...
c--------------------------------------------------------------------|
     ...
     &*SIN((decN-dec)*3.141592654/180.)))))/3.141592654
            ...
            radec(i,j,3)=rot
          IF(ra.gt.180.) then
            if((dec.gt.(35.+(2.828*ancho))).or.
     &(dec.lt.(10-(2.828*ancho)))) then
              O(i,j)=-1
            endif
            if(ra.lt.(330.-(2.828*ancho
     &/cos(dec*3.141592654/180.)))) then
              O(i,j)=-1
            endif
          else
            if((dec.gt.(46.+(2.828*ancho))).or.
     &(dec.lt.(-1.25-(2.828*ancho)))) then
              O(i,j)=-1
            endif
            if(ra.gt.(42.+(2.828*ancho
     &/cos(dec*3.141592654/180.)))) then
              O(i,j)=-1
            endif
            if((ra.gt.(33.+(2.828*ancho
     &/cos(dec*3.141592654/180.)))).and.
     &(dec.gt.(8.+(2.828*ancho))).and.
     &(dec.lt.(28.-(2.828*ancho))))  then
              O(i,j)=-1
            endif
          endif
